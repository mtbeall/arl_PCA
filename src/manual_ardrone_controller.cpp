...
// THIS NEEDS TO BE UPDATED TO INCLUDE THE DYNAMICS MODEL OF GIVING A GOAL POSITION AND OUTPUTTING A CONTROL INPUT. CAN USE LQR ABOUT NEW DYNAMICS MODEL GIVEN MANUAL JOYSTICK INPUTS FROM A HUMAN.
#include <ros/ros.h>
